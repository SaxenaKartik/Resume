...
\geometry{verbose, tmargin=1mm, bmargin=1mm, lmargin=2mm, rmargin=2mm}
\linespread{1.5}
...
\resumeSubHeadingListStart
    ...
    {}{}
      \resumeItemListStart
        ...
        % \resumeItem{Latency Improvement}
        %   {Improving the TTI latency of our service via frontend optimizations using chrome dev tools and lighthouse reports }
        % \resumeItem{Widget Enhancement}
        %   {Through UI, Backend and Model updates for providing necessary functionality to the sellers }
      \resumeItemListEnd
    \resumeSubHeadingListEnd
